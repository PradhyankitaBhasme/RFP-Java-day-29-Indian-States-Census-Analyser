...
public class StateCensusAnalyserTest {
    ...
    static final String CSV_FILE_PATH = PATH.concat("//src//main//resources//Indian_States_Census.csv");
    static final String INCORRECT_FILE_PATH = PATH.concat("//src//main//resources//Indian_StatesCensus.csv");
    static final String INCORRECT_TYPE_FILE_PATH = PATH.concat("//src//main//resources//Indian_StatesCensus.pde");
    static final String INCORRECT_DELIMITER_FILE_PATH = PATH.concat("//src//main//resources//Indian_States_Census_Incorrect_Delimiter.csv");
    static final String INCORRECT_HEADER_FILE_PATH = PATH.concat("//src//main//resources//Indian_States_Census_Incorrect_header.csv");
